...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'CulipFWQ', // 您的昵称 例如 
  BIO: process.env.NEXT_PUBLIC_BIO || '一个优秀的Minecraft服务器管理者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.minecraftculip.us.kg', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '服务器,Minecraft', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL:mfhass123@outlook.com process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://b23.tv/0oaoNGq', // B站主页
